...
df_temp <- read_excel("Ipsos simulation template.xlsx")
...
df_sim_0 <- df_sim %>% 
  ...
  mutate(Perceived_sim1_1 = Sample_Mean(n = length(which(df_sim$Condition == -1)), mean = 3, sd = 1, min_val = 1, max_val = 5, int = T),
         ...
         Smartness_HP = Sample_Mean(n = length(which(df_sim$Condition == -1)), mean = 3, sd = 1, min_val = 1, max_val = 5, int = T),
         Smartness_MP_1 = Sample_Mean(n = length(which(df_sim$Condition == -1)), mean = 3, sd = 1, min_val = 1, max_val = 5, int = T),
         Smartness_MP_2 = Sample_Mean(n = length(which(df_sim$Condition == -1)), mean = 3, sd = 1, min_val = 1, max_val = 5, int = T),
         Smartness_LP = Sample_Mean(n = length(which(df_sim$Condition == -1)), mean = 3, sd = 1, min_val = 1, max_val = 5, int = T),
...
df_sim_1 <- df_sim %>% 
  ...
  mutate(Perceived_sim1_1 = Sample_Mean(n = length(which(df_sim$Condition == 1)), mean = 4, sd = 1, min_val = 1, max_val = 5, int = T),
         ...
         Smartness_MP_1 = Sample_Mean(n = length(which(df_sim$Condition == 1)), mean = 4, sd = 1, min_val = 1, max_val = 5, int = T),
         Smartness_MP_2 = Sample_Mean(n = length(which(df_sim$Condition == 1)), mean = 4, sd = 1, min_val = 1, max_val = 5, int = T),
         Smartness_LP = Sample_Mean(n = length(which(df_sim$Condition == 1)), mean = 4, sd = 1, min_val = 1, max_val = 5, int = T),
...
df_S_1 <- df_sim %>%  
  ...
  pivot_longer(cols = starts_with("Smart"),
               names_to = "item",
               values_to = "Y") %>% 
  mutate(Contrast = if_else(item == "Smartness_HP", -1, 1))
...
df_Stab_1 <- df_sim %>%  
  ...
  pivot_longer(cols = starts_with("Stability"),
               names_to = "item",
               values_to = "Y") %>% 
  mutate(Contrast = if_else(item == "Stability_LP_1", -1, 1))
...
df_Stab_2 <- df_sim %>%  
  ...
  pivot_longer(cols = starts_with("Stability"),
               names_to = "item",
               values_to = "Y") %>% 
  mutate(Contrast = if_else(item == "Stability_LP_2", -1, 1))
...
df_Stab_3 <- df_sim %>%  
  ...
  pivot_longer(cols = starts_with("Stability"),
               names_to = "item",
               values_to = "Y") %>% 
  mutate(Contrast = if_else(item == "Stability_LP_3", -1, 1))
...
df_Stab_4 <- df_sim %>%  
  ...
  pivot_longer(cols = starts_with("Stability"),
               names_to = "item",
               values_to = "Y") %>% 
  mutate(Contrast = if_else(item == "Stability_LP_4", -1, 1))
...
save(df_sim, file = "Simulation_data.RData")
